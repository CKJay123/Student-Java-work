...
<script type="text/javascript">
    ...
    var fillToTable = function (courseInfos) {
        ...
        $.each(courseInfos.list, function (index, courseInfo) {
            ...
            td = $("<td>");
            td.html("<button type='button' class='btn btn-default btn-sm' onclick='select_course("+courseInfo.courseId+")'>" +
                "<span class='glyphicon glyphicon-edit'></span> 选课" +
                "</button>");
            tr.append(td);
    ...
    function select_course(course_id) {
        ...
        //提交请求
        $.ajax({
            url: "${pageContext.request.contextPath}/course/ajax/selectCourse",
            type: "POST",
    ...
    function to_page(pageNum) {
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/course/ajax/unselectedCourses",
            data: "pageNum=" + pageNum,//pageNum是用户指定跳转的页码数
            type: "get",
